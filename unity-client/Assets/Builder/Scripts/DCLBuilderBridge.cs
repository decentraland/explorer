...
namespace Builder
{
    public class DCLBuilderBridge : MonoBehaviour
    {
        ...
        private void ProcessEntityBoundaries(DCLBuilderEntity entity)
        {
            ...
            DCL.SceneController.i.boundsChecker?.EvaluateEntityPosition(entity.rootEntity);
        }
        ...
        private void EvaluateSelectedEntitiesPosition()
        {
            if (selectedEntities != null)
            {
                ...
                {
                    DCL.SceneController.i.boundsChecker?.EvaluateEntityPosition(selectedEntities[i].rootEntity);
                }
            }
        }
