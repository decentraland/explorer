Shader "DCL/New Toon Shader"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // e2ecb5ae4be79f1b4cdc8b138161d6f1
            ...
            void SG_ToonShader_4cadc1cb7cae444909bd6637f15fdf84(TEXTURE2D_PARAM(Texture2D_73021B24, samplerTexture2D_73021B24), float4 Texture2D_73021B24_TexelSize, float Vector1_1431D892, float Vector1_C2B7F43A, float4 Vector4_453A6B1F, float Vector1_55629F98, float4 Vector4_752D3319, float3 Vector3_FEFB7F68, float4 Vector4_D503119C, Bindings_ToonShader_4cadc1cb7cae444909bd6637f15fdf84 IN, out float4 OutVector4_1)
            {
                ...
                float _Step_6C9E9BC2_Out_2;
                Unity_Step_float(0.1, _Power_5DFD9006_Out_2, _Step_6C9E9BC2_Out_2);
                float4 _Property_C0DBEB4D_Out_0 = Vector4_752D3319;
                float4 _Multiply_D3D0BB31_Out_2;
                Unity_Multiply_float((_Step_6C9E9BC2_Out_2.xxxx), _Property_C0DBEB4D_Out_0, _Multiply_D3D0BB31_Out_2);
                ...
                float _Step_50FACD18_Out_2;
                Unity_Step_float(0.1, _Multiply_F7826E20_Out_2, _Step_50FACD18_Out_2);
                float4 _Property_3F2E1C08_Out_0 = Vector4_453A6B1F;
                float4 _Multiply_56052616_Out_2;
                Unity_Multiply_float((_Step_50FACD18_Out_2.xxxx), _Property_3F2E1C08_Out_0, _Multiply_56052616_Out_2);
                ...
                float4 _SampleTexture2D_D0991351_RGBA_0 = SAMPLE_TEXTURE2D(Texture2D_73021B24, SamplerState_Trilinear_Repeat, _Vector2_5DAC94A7_Out_0);
            ...
            void SG_FinalCombine_71273f7177aa0cc4f9ddbeefd14a5fbb(float4 Color_E739F888, float4 Color_D4F585C6, float4 Color_D7818A04, Bindings_FinalCombine_71273f7177aa0cc4f9ddbeefd14a5fbb IN, out float4 FinalColor_1)
            {
                ...
                FinalColor_1 = _Add_380AFE1D_Out_2;
            }
            ...
            SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
            {
                ...
                float4 Color_6481DB60 = IsGammaSpace() ? float4(0.5188679, 0.5188679, 0.5188679, 0) : float4(SRGBToLinear(float3(0.5188679, 0.5188679, 0.5188679)), 0);
                float4 Color_FC39AC41 = IsGammaSpace() ? float4(0.6415094, 0.6415094, 0.6415094, 0) : float4(SRGBToLinear(float3(0.6415094, 0.6415094, 0.6415094)), 0);
                float3 _CustomFunction_C0D68817_Direction_0;
                float3 _CustomFunction_C0D68817_Color_1;
                float _CustomFunction_C0D68817_Attenuation_2;
                GetLightingInformation_float(_CustomFunction_C0D68817_Direction_0, _CustomFunction_C0D68817_Color_1, _CustomFunction_C0D68817_Attenuation_2);
                ...
                SG_ToonShader_4cadc1cb7cae444909bd6637f15fdf84(TEXTURE2D_ARGS(_MatCap, sampler_MatCap), _MatCap_TexelSize, 2, -1, Color_6481DB60, 0.2, Color_FC39AC41, _Normalize_6188E847_Out_1, (float4(_CustomFunction_C0D68817_Color_1, 1.0)), _ToonShader_FA30CA77, _ToonShader_FA30CA77_OutVector4_1);
                float4 Color_4CE4E507 = IsGammaSpace() ? float4(0.9528302, 0.9528302, 0.9528302, 1) : float4(SRGBToLinear(float3(0.9528302, 0.9528302, 0.9528302)), 1);
