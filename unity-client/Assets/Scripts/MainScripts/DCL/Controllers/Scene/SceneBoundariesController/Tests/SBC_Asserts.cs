...
namespace SceneBoundariesCheckerTests
{
    public static class SBC_Asserts
    {
        public static IEnumerator EntitiesAreBeingCorrectlyRegistered(ParcelScene scene)
        {
            ...
            Assert.AreEqual(2, Environment.i.sceneController.boundariesChecker.entitiesToCheckCount, "entities to check can't be zero!");
            ...
            Assert.AreEqual(0, Environment.i.sceneController.boundariesChecker.entitiesToCheckCount, "entities to check should be zero!");
        ...
        public static bool MeshIsInvalid(DecentralandEntity.MeshesInfo meshesInfo)
        {
            ...
            if (Environment.i.debugConfig.isDebugMode)
            {
