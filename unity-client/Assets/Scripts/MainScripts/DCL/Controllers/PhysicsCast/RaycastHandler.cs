...
namespace DCL.Helpers
{
    public class RaycastHandler : IRaycastHandler
    {
        ...
        {
            hitInfo.point = Environment.i.world.worldState.ConvertUnityToScenePosition(hit.point);
        ...
        private void SetRaycastInfoData(ref RaycastHitInfo hitInfo, ParcelScene scene)
        {
            ...
            else if (scene == null && Environment.i.world.worldState.IsCharacterInsideScene(info.scene))
