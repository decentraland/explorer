Shader "DCL/Toon Shader"
{
    ...
    SubShader
    {
        ...
        #define VARYINGS_NEED_VIEWDIRECTION_WS
            ...
            float4 _LightColor;
            float4 _TintColor;
            SAMPLER(_SampleTexture2D_83152ba698eae68f8c4de6f957f78ad4_Sampler_3_Linear_Repeat);
            SAMPLER(_SampleTexture2D_d98ff5fa7623c28c9322adf358842569_Sampler_3_Linear_Repeat);
            SAMPLER(_SampleTexture2D_ad1d95648856ff818e55be9d0b398cfc_Sampler_3_Linear_Repeat);
            SAMPLER(_SampleTexture2D_44f962ee9e174d828af166a2779a14e9_Sampler_3_Linear_Repeat);
            SAMPLER(_SampleTexture2D_c83f1a690e3cc688a0c44677a104da34_Sampler_3_Linear_Repeat);
            ...
            void SG_TextureSample_556dc6c40f462774daf8a2ff53e16c59(float4 Vector4_DA7BBBB2, TEXTURE2D_PARAM(Texture2D_4C630F34, samplerTexture2D_4C630F34), float4 Texture2D_4C630F34_TexelSize, Bindings_TextureSample_556dc6c40f462774daf8a2ff53e16c59 IN, out float4 Color_1, out float Alpha_2)
            {
                ...
                float4 _SampleTexture2D_d98ff5fa7623c28c9322adf358842569_RGBA_0 = SAMPLE_TEXTURE2D(Texture2D_4C630F34, samplerTexture2D_4C630F34, IN.uv0.xy);
            ...
            void SG_ToonShader_4cadc1cb7cae444909bd6637f15fdf84(TEXTURE2D_PARAM(Texture2D_8319D4A3, samplerTexture2D_8319D4A3), float4 Texture2D_8319D4A3_TexelSize, TEXTURE2D_PARAM(Texture2D_E7BDB00A, samplerTexture2D_E7BDB00A), float4 Texture2D_E7BDB00A_TexelSize, TEXTURE2D_PARAM(Texture2D_73021B24, samplerTexture2D_73021B24), float4 Texture2D_73021B24_TexelSize, float Vector1_1431D892, float Vector1_C2B7F43A, float4 Vector4_453A6B1F, float Vector1_55629F98, float4 Vector4_752D3319, float3 Vector3_FEFB7F68, float4 Vector4_D503119C, float Vector1_11D631DE, float4 Vector4_92D383D7, Bindings_ToonShader_4cadc1cb7cae444909bd6637f15fdf84 IN, out float4 OutVector4_1)
            {
                ...
                float4 _SampleTexture2D_ad1d95648856ff818e55be9d0b398cfc_RGBA_0 = SAMPLE_TEXTURE2D(Texture2D_E7BDB00A, samplerTexture2D_E7BDB00A, _Vector2_9a8bf5774b4fbe81af3b38cdf9759855_Out_0);
                ...
                float4 _SampleTexture2D_44f962ee9e174d828af166a2779a14e9_RGBA_0 = SAMPLE_TEXTURE2D(Texture2D_8319D4A3, samplerTexture2D_8319D4A3, _Vector2_902927a430b8848cac4001e2b7162a76_Out_0);
                ...
                float4 _SampleTexture2D_c83f1a690e3cc688a0c44677a104da34_RGBA_0 = SAMPLE_TEXTURE2D(Texture2D_73021B24, samplerTexture2D_73021B24, _Vector2_f73d51750aa36989a7dac5bb620f51ba_Out_0);
            ...
            SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
            {
                ...
                #endif
                #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1) || defined(KEYWORD_PERMUTATION_2) || defined(KEYWORD_PERMUTATION_3) || defined(KEYWORD_PERMUTATION_4) || defined(KEYWORD_PERMUTATION_5) || defined(KEYWORD_PERMUTATION_6) || defined(KEYWORD_PERMUTATION_7)
                float4 _SampleTexture2D_83152ba698eae68f8c4de6f957f78ad4_RGBA_0 = SAMPLE_TEXTURE2D(_EmissionMap, sampler_EmissionMap, IN.uv0.xy);
