...
export class Creature {
  ...
  UpdateTemperatureText() {
    ...
    if (this.IsAtIdealTemperature()) this.temperatureText.color = Color3.Green()
    else this.temperatureText.color = Color3.Red()
  }
  ...
  UpdateTemperatureIcons() {
    ...
    else this.hotIconEntityTransform.scale.set(0, 0, 0)
    ...
    else this.coldIconEntityTransform.scale.set(0, 0, 0)
  }
  ...
  SetEnvironment(newEnvironment: Environment | null) {
    ...
    if (this.environment) this.environment.addCreature(this)
