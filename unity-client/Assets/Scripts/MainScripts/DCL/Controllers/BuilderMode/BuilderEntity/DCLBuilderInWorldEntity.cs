...
public class DCLBuilderInWorldEntity : EditableEntity
{
    ...
    public void Select()
    {
        ...
        DCL.Environment.i.sceneController.boundariesChecker.AddPersistent(rootEntity);
    }
    ...
    public void Deselect()
    {
        ...
        DCL.Environment.i.sceneController.boundariesChecker.RemoveEntityToBeChecked(rootEntity);
