...
namespace DCL.Controllers
{
    public class ParcelScene : MonoBehaviour
    {
        ...
        public virtual void SetData(LoadParcelScenesMessage.UnityParcelScene data)
        {
            ...
            if (debugConfig.debugScenes && debugConfig.debugSceneCoords != data.basePosition)
            {
                SetSceneReady();
                return;
            }
        ...
        public DecentralandEntity CreateEntity(string id)
        {
            ...
            if (Environment.i.sceneController.useBoundariesChecker)
                newEntity.OnShapeUpdated += Environment.i.sceneController.boundariesChecker.AddEntityToBeChecked;
        ...
        void CleanUpEntityRecursively(DecentralandEntity entity, bool removeImmediatelyFromEntitiesList)
        {
            ...
            if (Environment.i.sceneController.useBoundariesChecker)
            {
                entity.OnShapeUpdated -= Environment.i.sceneController.boundariesChecker.AddEntityToBeChecked;
                Environment.i.sceneController.boundariesChecker.RemoveEntityToBeChecked(entity);
            }
        ...
        public void SetEntityParent(string entityId, string parentId)
        {
            ...
            if (parentId == "FirstPersonCameraEntityReference" || parentId == "PlayerEntityReference") // PlayerEntityReference is for compatibility purposes
            {
                ...
                Environment.i.sceneController.boundariesChecker.AddPersistent(me);
            }
            ...
            else
            {
                ...
                {
                    Environment.i.sceneController.boundariesChecker.RemoveEntityToBeChecked(me);
                }
        ...
        public BaseComponent EntityComponentCreateOrUpdateFromUnity(string entityId, CLASS_ID_COMPONENT classId, object data)
        {
            ...
            if (classId == CLASS_ID_COMPONENT.TRANSFORM)
            {
                ...
                else
                {
                    ...
                    Environment.i.sceneController.boundariesChecker?.AddEntityToBeChecked(entity);
                }
