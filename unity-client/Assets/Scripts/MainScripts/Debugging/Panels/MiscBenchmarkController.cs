...
namespace DCL
{
    ...
    public class MiscBenchmarkController : MonoBehaviour, IBenchmarkController
    {
        ...
        void Update()
        {
            int messagesProcessedLastFrame = lastPendingMessages - Environment.i.messaging.messagingControllersManager.pendingMessagesCount;
            ...
            lastPendingMessages = Environment.i.messaging.messagingControllersManager.pendingMessagesCount;
        }
        ...
        private IEnumerator RefreshProfilingData()
        {
            while (true)
            {
                ...
                var loadedScenes = Environment.i.world.worldState.loadedScenes;
                ...
                using (var controllersIter = Environment.i.messaging.messagingControllersManager.messagingControllers.GetEnumerator())
                {
