...
const wearableId1 = 'dcl://base-avatars/name'
...
describe('Wearables Saga', () => {
  ...
  it('When a wearable is requested by id, then it is returned successfully', () => {
    return expectSaga(handleWearablesRequest, wearablesRequest({ wearableIds: ['urn:decentraland:off-chain:base-avatars:name'] }, context))
