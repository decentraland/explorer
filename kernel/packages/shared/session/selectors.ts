...
export const getIsGuestLogin = (state: RootSessionState): boolean | undefined => state.session.isGuestLogin
...
export const isLoginStageCompleted = (state: RootSessionState) => state.session.loginStage === LoginState.COMPLETED
