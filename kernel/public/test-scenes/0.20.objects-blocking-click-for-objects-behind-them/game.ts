...
const gltfShape2 = new GLTFShape('models/Module_Stone_Curve_01/Module_Stone_Curve_01.glb')
...
const gltfShape3 = new GLTFShape('models/Wall_Stone_Medium/Wall_Stone_Medium.glb')
