...
export const initializeRenderer = (container: HTMLElement, buildConfigPath: string, webSocketUrl: string | undefined) =>
  action(INITIALIZE_RENDERER, { container, buildConfigPath, webSocketUrl })
