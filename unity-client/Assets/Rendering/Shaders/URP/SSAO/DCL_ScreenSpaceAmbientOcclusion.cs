...
namespace DCL.Rendering.Universal
{
    internal static class PostProcessUtils
    {
    ...
    class DCL_ScreenSpaceAmbientOcclusion : ScriptableRendererFeature
    {
        // Serialized Fields
        ...
        // Constants
        private const string k_ShaderName = "Hidden/DCL/Universal Render Pipeline/ScreenSpaceAmbientOcclusion";
