...
namespace DCL
{
    public static class AssetBundleMenuItems
    {
        ...
        // TODO: Update this method to have those other 2 calls sequentially and end up with the _Downloads folder containing all body wearables with skeleton and non-body wearablaes optimized
