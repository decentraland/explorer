...
namespace DCL.Rendering
{
    ...
    {
        [Header("Renderer Profile")] public CullingControllerProfile rendererProfileMin;
        public CullingControllerProfile rendererProfileMax;

        [Header("Skinned Renderer Profile")] public CullingControllerProfile skinnedRendererProfileMin;
