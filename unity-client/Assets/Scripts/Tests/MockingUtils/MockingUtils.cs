...
public interface IDummyEventSubscriber<T1, T2, T3, T4> { void React(T1 p1, T2 p2, T4 p4); }
public interface IDummyEventSubscriber<T1, T2, T3, T4, T5> { void React(T1 p1, T2 p2, T5 p5); }