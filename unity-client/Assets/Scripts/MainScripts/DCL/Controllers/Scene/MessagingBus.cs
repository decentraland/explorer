...
namespace DCL
{
    ...
    public class MessagingBus : IDisposable
    {
        ...
        public List<QueuedSceneMessage> pendingMessages = new List<QueuedSceneMessage>(10000);
        ...
        Dictionary<string, int> unreliableMessages = new Dictionary<string, int>();
        ...
        private void AddReliableMessage(QueuedSceneMessage message)
        {
