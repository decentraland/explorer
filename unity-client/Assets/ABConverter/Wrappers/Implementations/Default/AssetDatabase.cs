...
namespace DCL
{
    public static partial class UnityEditorWrappers
    {
        public class AssetDatabase : IAssetDatabase
        {
            ...
            {
                string assetPath = ABConverter.Utils.FullPathToAssetPath(fullPath);
            ...
            {
                string assetPathSrc = ABConverter.Utils.FullPathToAssetPath(fullPathSrc);
                string assetPathDst = ABConverter.Utils.FullPathToAssetPath(fullPathDst);
            ...
            {
                return ABConverter.Utils.AssetPathToFullPath(UnityEditor.AssetDatabase.GetAssetPath(asset));
            }
            ...
            {
                string assetPath = ABConverter.Utils.FullPathToAssetPath(fullPath);
                return ABConverter.Utils.AssetPathToFullPath(UnityEditor.AssetDatabase.GetTextMetaFilePathFromAssetPath(assetPath));
            }
        }
    }
}