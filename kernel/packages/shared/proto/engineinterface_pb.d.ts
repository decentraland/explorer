...
export class PB_CreateEntityWithComponents extends jspb.Message {
  getId(): string;
  setId(value: string): void;

  clearComponentsList(): void;
  getComponentsList(): Array<PB_UpdateEntityComponent>;
  setComponentsList(value: Array<PB_UpdateEntityComponent>): void;
  addComponents(value?: PB_UpdateEntityComponent, index?: number): PB_UpdateEntityComponent;

  clearAttachedcomponentsList(): void;
  getAttachedcomponentsList(): Array<PB_AttachEntityComponent>;
  setAttachedcomponentsList(value: Array<PB_AttachEntityComponent>): void;
  addAttachedcomponents(value?: PB_AttachEntityComponent, index?: number): PB_AttachEntityComponent;

  getParentid(): string;
  setParentid(value: string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): PB_CreateEntityWithComponents.AsObject;
  static toObject(includeInstance: boolean, msg: PB_CreateEntityWithComponents): PB_CreateEntityWithComponents.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: PB_CreateEntityWithComponents, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): PB_CreateEntityWithComponents;
  static deserializeBinaryFromReader(message: PB_CreateEntityWithComponents, reader: jspb.BinaryReader): PB_CreateEntityWithComponents;
}

export namespace PB_CreateEntityWithComponents {
  export type AsObject = {
    id: string,
    componentsList: Array<PB_UpdateEntityComponent.AsObject>,
    attachedcomponentsList: Array<PB_AttachEntityComponent.AsObject>,
    parentid: string,
  }
}
...
export class PB_SendSceneMessage extends jspb.Message {
  ...
  hasCreateentitywithcomponents(): boolean;
  clearCreateentitywithcomponents(): void;
  getCreateentitywithcomponents(): PB_CreateEntityWithComponents | undefined;
  setCreateentitywithcomponents(value?: PB_CreateEntityWithComponents): void;
...
export namespace PB_SendSceneMessage {
  export type AsObject = {
    ...
    createentitywithcomponents?: PB_CreateEntityWithComponents.AsObject,
  }
