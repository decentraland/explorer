...
public class BuilderInWorldEntityHandler : MonoBehaviour
{
    ...
    public void DeselectEntity(DCLBuilderInWorldEntity entity)
    {
        ...
        if (!SceneController.i.boundsChecker.IsEntityInsideSceneBoundaries(entity.rootEntity))
        {
            DestroyLastCreatedEntities();
        }

        SceneController.i.boundsChecker.EvaluateEntityPosition(entity.rootEntity);
        SceneController.i.boundsChecker.RemoveEntityToBeChecked(entity.rootEntity);
        entity.Deselect();
