...
const mapDispatchToProps = (dispatch: any) => ({
  onLogin: () => dispatch({ type: '[Request] Login', payload: { provider: 'Metamask' } }),
  onTermsChange: (e: React.ChangeEvent<HTMLInputElement>) => dispatch({ type: 'UPDATE_TOS', payload: e.target.checked })
})
    ...
    {props.stage !== LoginStage.COMPLETED && (
      <div className="login">
        ...
        <div className="eth-login-popup">
          <Logo />
          {(props.stage === LoginStage.SING_IN || props.stage === LoginStage.LOADING) && (
            <EthLogin
              terms={props.terms}
